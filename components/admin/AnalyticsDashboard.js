  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="p-6 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl shadow-lg flex items-center space-x-4">
        ...
        <div className="p-6 bg-gradient-to-br from-green-50 to-green-100 rounded-xl shadow-lg flex items-center space-x-4">
        ...
        <div className="p-6 bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl shadow-lg flex items-center space-x-4">
      ...
      <div className="bg-white p-6 rounded-xl shadow-lg">
        ...
        <ResponsiveContainer width="100%" height={300}>
          <BarChart data={reservationData}>
            ...
            <Legend />
            <Bar dataKey="reservations" fill="#dc2626" radius={[4, 4, 0, 0]} />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
